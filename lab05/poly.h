...
//
// CLASS PROVIDED:
//   class polynomial (in the namespace coen79_lab5)
...
//
//
// The value semantics (copy constructor and assignment operator) are overridden for
...
namespace coen79_lab5
{
    ...
    public:
        ...
        // HELPER FUNCTION
        void update_current_degree();
        unsigned int current_size() const { return size; };
    ...
    void write_gif_header128(std::ostream& out, int width, int height, const char color_table[128][3]);

    void make_gif(const polynomial& p, const char filename[ ], double low_x, double high_x, double low_y, double high_y);
}
#endif
